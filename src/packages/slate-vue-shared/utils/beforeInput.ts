 ...
 *
 * Inspired by react-dom but less complex:
 * https://github.com/facebook/react/blob/480626a9e920d5e04194c793a828318102ea4ff4/packages/react-dom/src/events/plugins/BeforeInputEventPlugin.js
 */
...
const getNativeBeforeInputChars = (domEventName: string, nativeEvent: any): string | null => {
...
function getFallbackBeforeInputChars(domEventName: string, nativeEvent: any): string | null {
...
const extractBeforeInputEvent = (domEventName: string, nativeEvent: Event) => {
