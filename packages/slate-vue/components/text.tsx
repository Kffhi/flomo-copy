...
import { PropType, defineComponent, provide, inject, ref } from 'vue'
import { KEY_TO_ELEMENT, NODE_TO_ELEMENT, ELEMENT_TO_NODE, PLACEHOLDER_SYMBOL, VueEditor } from '../../slate-vue-shared'
...
const Text = defineComponent({
    ...
    render() {
        ...
        // return <span data-slate-node="text">{children}</span>
        // TODO: ref
        return (
